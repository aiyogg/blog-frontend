    ...
    <div class="index-content">
      <div class="head-wrap">
        ...
        <div id="headlines">
          ...
          <h1 :class="{'current': now==5}" class="text-center textItem">Better to <span class="blue">run</span> than curse the road
          </h1>
        </div>
        <div class="text-center cat">记录分享我的技术成长之路</div>
      </div>
